...
Question.create(question: "How would you use a ternary operator", answer1: "if (condition) {value_if_true} else {value_if_false}", answer2: "If true: condition ? else {}", answer3: "", answer4: "condition ? value_if_true : value_if_false", answer: 4)
...
Question.create(question: "How to define an empty object called monster using const?", answer1: "const monster = {}", answer2: "const monster = []", answer3: "let monster = {}", answer4: "console.log(‘Hello world!’)", answer: 1)
